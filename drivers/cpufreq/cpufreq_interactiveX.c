						  ...
						  cputime64_t *wall)
{
	...
	busy_time  = kstat_cpu(cpu).cpustat[CPUTIME_USER];
	busy_time += kstat_cpu(cpu).kernel_cpustat.CPUTIME_SYSTEM;
	busy_time += kstat_cpu(cpu).kernel_cpustat.irq;
	busy_time += kstat_cpu(cpu).kernel_cpustat.softirq;
	busy_time += kstat_cpu(cpu).kernel_cpustat.steal;
	busy_time += kstat_cpu(cpu).kernel_cpustat.nice;
